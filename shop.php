...
<head>
    ...
    <style>
            ...
            max-height: 4rem; /* Two lines of text at 2rem each */
            overflow: hidden;
            ...
            <div class="container px-5 my-5">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="text-center">
                            ...
                            <p class="lead fw-normal text-muted mb-5">
                                "สินค้าของเรามาพร้อมกับคุณภาพและการบริการที่ดีที่สุด"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="search-form-container border">
                    <form class="d-flex w-100" method="POST" action="">
                        <input class="form-control me-2" type="search" name="search_query" placeholder="ค้นหาสินค้า..."
                            aria-label="Search">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="product_detail.php?product_id=' . $row['product_id'] . '">'; // เพิ่มลิงก์ไปยังหน้า product_detail.php พร้อมส่ง product_id ไปด้วย
                        echo '<img class="card-img-top" src="' . $row["image_url"] . '" alt="Product Image" />';
                        echo '</a>';
                        echo '<div class="card-body p-4">';
                        echo '<h5 class="card-title mb-3 fw-bold text-dark">' . $row["name"] . '</h5>';
                        echo '<p class="card-text text-muted product-description">' . $row["description"] . '</p>';
                        echo '</div>';
                        ...
                        echo '<a class="btn btn-pink2" href="product_detail.php?product_id=' . $row['product_id'] . '">Buy Now</a>'; // เพิ่มลิงก์ไปยังหน้า product_detail.php พร้อมส่ง product_id ไปด้วย
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
            ...
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                ...
                <div class="col-auto">
                    ...
                    <a class="link-light small text-decoration-none"
                        href="https://www.instagram.com/tp23_shop?igsh=MXBobXFwNnpobHM0cA%3D%3D&utm_source=qr"
                        target="_blank">
                        <i class="bi bi-instagram"></i> Instagram
                    </a>
                    <span class="text-white mx-1 ">&middot;</span>
                    <a class="link-light small text-decoration-none"
                        href="https://www.tiktok.com/@tp23_shop?_t=8o0ZBqDdza3&_r=1" target="_blank">
